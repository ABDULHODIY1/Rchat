...
toggleMic.addEventListener('click', ()=>{ localStream.getAudioTracks()[0].enabled = !localStream.getAudioTracks()[0].enabled; });

toggleCamera.addEventListener('click', ()=>{ localStream.getVideoTracks()[0].enabled = !localStream.getVideoTracks()[0].enabled; });
...
socket.on('partner-disconnected', ()=>console.log('Partner disconnected'));